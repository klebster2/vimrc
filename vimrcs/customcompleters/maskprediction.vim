...
fun! CallMaskPredictionApi()
    ...
    let l:endpoint = '"http://0.0.0.0:8080/mask_prediction/"'
    let l:content_type_header = '"Content-Type:application/json" '

    let l:data = "'{\"text\":\"".l:query_word."\",\"model\":\"bert-base-uncased\",\"mask_position\":".col('.')."}'"
    ...
    for m in l:data["unmasked_candidates"]
    " Record what matches − pass this to complete() later
    ...
    return ''
endfun
" #inoremap <C-x><C-w> <C-r>=CallMaskPredictionApi()<CR>
" hello, old friend
